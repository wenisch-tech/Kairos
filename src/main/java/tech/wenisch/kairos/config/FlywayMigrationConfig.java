...
import db.migration.V29__add_only_tagged_resources_to_discovery;
...
import db.migration.V31__add_availability_percentage_decimal_places_setting;
import db.migration.V32__repair_availability_percentage_decimal_places_setting;
...
public class FlywayMigrationConfig {
    ...
    FlywayConfigurationCustomizer kairosFlywayJavaMigrations() {
        return configuration -> configuration.javaMigrations(
                ...
                new V29__add_only_tagged_resources_to_discovery(),
                new V30__add_application_time_zone_setting(),
                new V31__add_availability_percentage_decimal_places_setting(),
